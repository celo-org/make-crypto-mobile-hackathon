  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.head}>
        <SquareButton iconChildren={Back} />
      </View>
      <View>
        <Image
          source={{
      ...
      <View style={styles.detailsContainer}>
        <View style={styles.detailsHeader}>
          ...
          <Likes
            ...
            textColor={colors.light.neutralColor7}
            textFontFamily={fontsFamily.montserratAlternates.regular400}
            textFontSize={fontSizes.xxs10}
          />
        </View>
