  ...
  render() {
    ...
    <div class="container flow-container" >
        <div class="d-flex justify-content-center flex-column mt-5 options-list">
            <a href={`/add-impact-type?id=${this.state.thread_id}`}  class="options-item">Carbon Impact Analysis</a>
            <a href={`/add-impact-type?id=${this.state.thread_id}`} class="options-item">Political Lobbying Analysis</a>
            <a href={`/add-impact-type?id=${this.state.thread_id}`} class="options-item">AGI Capabilities Analysis</a>
        </div>
