...
contract('NFTMarketplace', (accounts) => {
  ...
  describe('Fill Offer', () => {
    ...
    it('The CELO sent should match the price', async() => {
      await expectRevert(mktContract.fillOffer(2, { from: accounts[1], value: 5 }), 'The CELO amount should match with the NFT Price');
    });
  });
