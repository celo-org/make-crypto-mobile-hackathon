        ...
        <div class="flex flex-col items-center sm:px-5 md:flex-row">
            ...
            <div class="flex flex-col items-start justify-center w-full h-full py-6 mb-6 md:mb-0 md:w-1/2">
                <div class="flex flex-col items-start justify-center h-full space-y-3 transform md:pl-10 lg:pl-16 md:space-y-5">
                    ...
                    <h1 class="text-4xl font-bold leading-none lg:text-5xl xl:text-6xl"><a href="#_">Blockchain Technology that saves Lives.</a></h1>
                    <p class="pt-2 text-lg font-medium">We are building a fully decentralized medical fundraising platform built using Celo Blockchain technology</p>
                </div>
            </div>
        </div>
  </div>
