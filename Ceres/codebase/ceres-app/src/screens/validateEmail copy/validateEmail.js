      ...
      {!user.emailVerified ? 
        <Fragment> 
          <View style = {{marginTop: 24, marginBottom: 24}}>
            <Text category = 's1' style = {{textAlign: 'center', marginTop: 16, marginBottom: 16}}>{requestSent ? 'Enviamos um código de confirmação via EMAIL' : 'Enviando código de confirmação'}</Text>   
          </View> 
          <LottieView
